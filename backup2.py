...
"}")
        ...
        self.dashboardSales.setGeometry(QtCore.QRect(350, 340, 121, 21))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.changeScreen = QtWidgets.QWidget()
        self.changeScreen.setObjectName("changeScreen")
        self.changeFrame = QtWidgets.QFrame(self.changeScreen)
        self.changeFrame.setGeometry(QtCore.QRect(0, 0, 771, 501))
        self.changeFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.changeFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.changeFrame.setObjectName("changeFrame")
        self.changeLabel1 = QtWidgets.QLabel(self.changeFrame)
        self.changeLabel1.setGeometry(QtCore.QRect(310, 80, 160, 21))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.changeLabel1.setFont(font)
        self.changeLabel1.setStyleSheet("color: rgb(117, 117, 117)")
        self.changeLabel1.setObjectName("changeLabel1")
        self.changeUsername = QtWidgets.QLineEdit(self.changeFrame)
        self.changeUsername.setGeometry(QtCore.QRect(250, 150, 251, 31))
        self.changeUsername.setObjectName("changeUsername")
        self.changePassword = QtWidgets.QLineEdit(self.changeFrame)
        self.changePassword.setGeometry(QtCore.QRect(250, 220, 251, 31))
        self.changePassword.setObjectName("changePassword")
        self.changeSave = QtWidgets.QPushButton(self.changeFrame)
        self.changeSave.setGeometry(QtCore.QRect(250, 300, 111, 41))
        self.changeSave.setStyleSheet("QPushButton#changeSave{\n"
"    color: rgb(255, 255, 255);\n"
"    background-color: rgb(102, 150, 200);\n"
"    border: 0px solid;\n"
"    border-radius: 5px;\n"
"}\n"
"\n"
"QPushButton:hover#changeSave{\n"
"    background-color: rgb(113, 167, 221)\n"
"}")
        self.changeSave.setObjectName("changeSave")
        self.changeCancel = QtWidgets.QPushButton(self.changeFrame)
        self.changeCancel.setGeometry(QtCore.QRect(390, 300, 111, 41))
        self.changeCancel.setStyleSheet("QPushButton#changeCancel{\n"
"    color: rgb(255, 255, 255);\n"
...
"}\n"
"\n"
"QPushButton:hover#changeCancel{\n"
"    background-color: rgb(255, 119, 65);\n"
"}")
        self.changeCancel.setObjectName("changeCancel")
        self.mainScreens.addWidget(self.changeScreen)
...
"}")
    ...
    def getTotalSalesDB(self):
          ...
          if result[0] is None:
               ...
               self.dashboardSales.setText(str(result[0]))
    ...
    def generateReport(self, text):
        ...
        html = """<html>
               ...
               /</head>"""
        html += "<h3>JL Neon Sales Automation System</h3><h3>Sales Report</h3><h3>"+text+"</h3><table class='cent'><thead>"
        html += "<tr>"
        ...
        for r in range(model.rowCount()):
             ...
             for c in range(columnCount):
                  ...
                  if c == 3:
                       totalAmount = decimal.Decimal(totalAmount) + decimal.Decimal(model.index(r, c).data())
             html += "</tr>"
        html += "</tbody></table> <h3> Total Sales: "+str(totalAmount)+" <h3> Number of sales: "+str(model.rowCount())+""
        doc.setHtml(html)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.changeLabel1.setText(_translate("MainWindow", "Edit Credential"))
        self.changeUsername.setPlaceholderText(_translate("MainWindow", " Username"))
        self.changePassword.setPlaceholderText(_translate("MainWindow", " Password"))
        self.changeSave.setText(_translate("MainWindow", "Save"))
        self.changeCancel.setText(_translate("MainWindow", "Cancel"))
